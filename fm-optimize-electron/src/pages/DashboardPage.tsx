...
export default function DashboardPage() {
  ...
  const systemHealth = useMemo(() => {
    ...
    const avgDriveUsage = drives.length > 0
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs font-semibold text-primary uppercase tracking-wider">Painel do Sistema</span>
              </div>
              ...
              {systemHealth && (
                <div className="text-right">
                  <div className={cn(
                    ...
                    systemHealth.health >= 80 ? 'text-emerald-400' :
                    systemHealth.health >= 50 ? 'text-amber-400' : 'text-red-400'
                  )}>
                    {systemHealth.health}%
                  </div>
      ...
      <div className="flex items-center justify-between rounded-xl border border-border bg-card p-4">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>Atividade: <span className="font-medium text-foreground">{formatUptime(data.uptime)}</span></span>
          </div>
        </div>

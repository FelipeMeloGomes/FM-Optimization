    ...
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-xl border border-primary/20 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent">
        ...
        <div className="relative p-6">
          ...
          <h2 className="text-lg font-bold text-foreground">Mantenha seu Windows limpo e rápido</h2>
          <p className="text-sm text-muted-foreground mt-1 max-w-lg">
            Remova arquivos temporários, cache de atualizações e dados de navegadores para liberar
            espaço e melhorar a performance do sistema.
          </p>
        </div>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="mt-4 flex gap-2">
                ...
                {isExecuting && (
                  <Button variant="destructive" size="sm" onClick={() => handleCancel(card.id)}>
                    Cancelar
                  </Button>
                )}
              </div>
              ...
              {script?.riskLevel === 'deep' && (
                <div className="mt-3 flex items-start gap-2 rounded-lg bg-red-500/5 p-2 border border-red-500/10">
                  ...
                  <p className="text-[10px] text-red-400/80 leading-relaxed">
                    Esta limpeza é mais agressiva. Recomendada apenas uma vez por mês para manter o
                    sistema estável.
                  </p>
                </div>
              )}
